...
if(arch eq "cpu"){
	...
	if(machine eq "manticore"){
		...
		params="1_40_NVIDIA-Graphics-Device" 
	}}}
	...
	if(machine eq "manticore"){
		...
		params="1_40_NVIDIA-Graphics-Device_NVIDIA-CUDA" 
	}}}
	...
	# Set default params
	params="0_40_Radeon-Pro-WX-9100" 
}else{
	print "invalid arch"
	exit
...
outfile = result_dir.machine."/plots/matrix_pow/plot_".arch."_matpow_size.eps"
set output outfile
...
data_dir=result_dir.machine."/stats/matrix_pow/".arch."/size/"
if(arch eq "cpu"){
