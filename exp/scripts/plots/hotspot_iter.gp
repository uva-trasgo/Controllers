...
if(arch eq "cpu"){
	...
	# Set default params
	if(machine eq "manticore"){
		params="1_10000_4_1_NVIDIA-Tesla-V100-PCIE-32GB" 
		set yrange [:25]
		set ytic add (25)
	}else { if(machine eq "medusa"){
		params="1_10000_4_1_NVIDIA-GeForce-GTX-TITAN-X" 
	}else { if(machine eq "gorgon"){
		params="1_10000_4_1_NVIDIA-Graphics-Device" 
	}}}
	...
	# Set default params
	if(machine eq "manticore"){
		params="1_10000_4_1_NVIDIA-Tesla-V100-PCIE-32GB_NVIDIA-CUDA" 
		set yrange [:25]
		set ytic add (25)
	}else { if(machine eq "medusa"){
		params="1_10000_4_1_NVIDIA-GeForce-GTX-TITAN-X_NVIDIA-CUDA" 
	}else { if(machine eq "gorgon"){
		params="1_10000_4_1_NVIDIA-Graphics-Device_NVIDIA-CUDA" 
	}}}
	...
	# Set default params
	params="0_10000_4_1_gfx900:xnack-_AMD-Accelerated-Parallel-Processing" 
}else{ if(arch eq "hip"){
	titlearch="HIP"
	...
	# Set default params
	params="0_10000_4_1_Radeon-Pro-WX-9100" 
}else{
	print "invalid arch"
	exit
...
# Set titles
basetitle="Hotspot (".machine." + ".titlearch.")"
set title basetitle

outfile = result_dir.machine."/plots/hotspot/plot_".arch."_hotspot_iter.eps"
set output outfile
...
data_dir=result_dir.machine."/stats/hotspot/".arch."/iter/"
if(arch eq "cpu"){
