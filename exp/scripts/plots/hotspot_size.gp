...
if(arch eq "cpu"){
	...
	# Set default params
	if(machine eq "manticore"){
		params="1_4_500_1_NVIDIA-Tesla-V100-PCIE-32GB" 
	}else { if(machine eq "medusa"){
		params="1_4_500_1_NVIDIA-GeForce-GTX-TITAN-X" 
	}else { if(machine eq "gorgon"){
		params="1_4_500_1_NVIDIA-Graphics-Device" 
	}}}
	...
	# Set default params
	if(machine eq "manticore"){
		params="1_4_500_1_NVIDIA-Tesla-V100-PCIE-32GB_NVIDIA-CUDA" 
	}else { if(machine eq "medusa"){
		params="1_4_500_1_NVIDIA-GeForce-GTX-TITAN-X_NVIDIA-CUDA" 
	}else { if(machine eq "gorgon"){
		params="1_4_500_1_NVIDIA-Graphics-Device_NVIDIA-CUDA"
	}}}
	...
	# Set default params
	params="0_4_500_1_gfx900:xnack-_AMD-Accelerated-Parallel-Processing" 
}else{ if(arch eq "hip"){
	titlearch="HIP"
	...
	# Set default params
	params="0_4_500_1_Radeon-Pro-WX-9100" 
}else{
	print "invalid arch"
	exit
...
outfile = result_dir.machine."/plots/hotspot/plot_".arch."_hotspot_size.eps"
set output outfile
...
data_dir=result_dir.machine."/stats/hotspot/".arch."/size/"
if(arch eq "cpu"){
