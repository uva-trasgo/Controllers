...
create_pblock pblock_GaussianBlur_1
add_cells_to_pblock [get_pblocks pblock_GaussianBlur_1] [get_cells -quiet [list design_1_i/GaussianBlur_1]]
resize_pblock [get_pblocks pblock_GaussianBlur_1] -add {SLICE_X0Y3:SLICE_X45Y43}
resize_pblock [get_pblocks pblock_GaussianBlur_1] -add {DSP48_X0Y2:DSP48_X2Y15}
resize_pblock [get_pblocks pblock_GaussianBlur_1] -add {RAMB18_X0Y2:RAMB18_X2Y15}
resize_pblock [get_pblocks pblock_GaussianBlur_1] -add {RAMB36_X0Y1:RAMB36_X2Y7}
set_property RESET_AFTER_RECONFIG true [get_pblocks pblock_GaussianBlur_1]
set_property SNAPPING_MODE ROUTING [get_pblocks pblock_GaussianBlur_1]
