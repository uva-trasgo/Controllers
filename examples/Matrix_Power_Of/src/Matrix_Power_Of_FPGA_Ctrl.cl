...
__CTRL_FPGA_KERNEL_OPTIMIZE_FOR(4, BLOCK_SIZE, BLOCK_SIZE, 1)
CTRL_KERNEL_FN(Mult, FPGA, NDRANGE, KHitTileR_arg(float, C), KHitTileR_arg(float, A), KHitTileR_arg(float, B), K_arg(int, A_width), K_arg(int, B_width))
