...
*/
CAL_KERNEL_XPHI(Mandelbrot, 8, IN, HitTile_float*, begin_x, IN,HitTile_float*, begin_y, IN, HitTile_float*, end_x, IN,HitTile_float*, end_y,IN,HitTile_float*, xsize,IN,HitTile_float*, ysize,  OUT, HitTile_float*, resultx,  OUT, HitTile_float*, resulty){
