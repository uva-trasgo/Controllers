...
#include "CAL_CntrlLibXPHI.h"
#include "CAL_KernelLibXPHI.h"
...
CAL_KERNEL_LIBXPHI(scopy, 5, IN, HitTile_float*, n_tile, IN, HitTile_float*, x, IN, HitTile_float*, incx_tile, IO, HitTile_float*, y, IN, HitTile_float*, incy_tile)
{
...
CAL_KERNEL_LIBXPHI(sgemv, 11, IN, HitTile_float*, trans_tile, IN, HitTile_float*, m_tile, IN, HitTile_float*, n_tile, IN, HitTile_float*, alpha_tile, IN, HitTile_float*, a, IN, HitTile_float*, lda_tile, IN, HitTile_float*, x, IN, HitTile_float*, incx_tile, IN, HitTile_float*, beta_tile, IO, HitTile_float*, y, IN, HitTile_float*, incy_tile)
{
...
CAL_KERNEL_LIBXPHI(sger, 9, IN, HitTile_float*, m_tile, IN, HitTile_float*, n_tile, IN, HitTile_float*, alpha_tile, IN, HitTile_float*, x, IN, HitTile_float*, incx_tile, IN, HitTile_float*, y, IN, HitTile_float*, incy_tile, IO, HitTile_float*, a, IN, HitTile_float*, lda_tile)
{
...
*/
    ...
    /* CREATE CNTRLS */
#ifdef USE_MKLBLAS
    CAL_CntrlCreate(&comm, CAL_CNTRL_LIBXPHI, 1);
